...
namespace chessGraphics
{
    public partial class Form1 : Form
    {
        ...
        string[] messages =  {
            ...
            "Unknown message",
            "Valid move - en passent"                               //added en passent to the massege array
            };
                 ...
                 Invoke((MethodInvoker)delegate {
                    ...
                    else if (res.ToLower().StartsWith("valid"))
                    {
                        ...
                        matBoard[dstSquare.Row, dstSquare.Col].FlatAppearance.BorderColor = Color.Blue;
                         ...
                         if (res.ToLower().Equals("valid move - en passent"))       //if the massege is en passent
                         {
                             if(isCurPlWhite)
                             {
                                 matBoard[dstSquare.Row + 1, dstSquare.Col].BackgroundImage = null;     //we remove the eaten pawn from the board
                             }
                             else
                             {
                                 matBoard[dstSquare.Row - 1, dstSquare.Col].BackgroundImage = null;     //we remove the eaten pawn from the board
